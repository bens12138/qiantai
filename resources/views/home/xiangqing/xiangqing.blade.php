...
@section('section')
        ...
        <div class="row">
            ...
            <div id="content" class="col-lg-10">
                <div class="item-meta">
                    <h1 class="meta-tit">耐克Nike男装针织套头衫-506989-050</h1>
                    <div class="meta-situ">
                        <div class="meta-magnifier pull-left">
                            <img src="/h_assets/img/advertise/magnifier.jpg" />
                        </div>
                        <div class="meta-show pull-right">
                            <h2 class="meta-maintit">耐克Nike男装针织套头衫-506989-050</h2>
                            ...
                            <div class="meta-reveal mb10">
                                <ul>
                                    ...
                                    <li class="reveal-sow rev-text-1">￥300.00</li>
                                    <li class="reveal-tit">市场价：</li>
                                    <li class="reveal-sow rev-text-2">￥200.00 <b class="rev-text-3 ml10">返积分：20</b> <b class="rev-text-4 ml10"><a href="">什么积分？</a></b></li>
